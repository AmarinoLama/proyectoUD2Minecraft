...
(9, 'Arena', 'Bloque utilizado para vidrio y otras construcciones', 64, NULL),
...
INSERT INTO BOOKS (BkId, BkName, BkType, BkAuthor, BkEnchantment, BkLevel) VALUES
                                                                               (21, 'Libro Encantado', 'Encantado', NULL, 'Eficiencia', 4),
                                                                               (22, 'Libro Escrito', 'Escrito', 'Steve', NULL, 0),
                                                                               (23, 'Libro Normal', 'Normal', NULL, NULL, 0),
                                                                               (24, 'Libro Encantado', 'Encantado', NULL, 'Toque de Seda', 1),
                                                                               (25, 'Libro Encantado', 'Encantado', NULL, 'Afinidad Acuática', 1),
                                                                               (26, 'Libro Encantado', 'Encantado', NULL, 'Inquebrantable', 3),
                                                                               (27, 'Libro Escrito', 'Escrito', 'Alex', NULL, 0),
                                                                               (28, 'Libro Encantado', 'Encantado', NULL, 'Toque de Seda', 2),
                                                                               (29, 'Libro Normal', 'Normal', NULL, NULL, 0),
                                                                               (30, 'Libro Encantado', 'Encantado', NULL, 'Mending', 1);
